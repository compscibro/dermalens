"""
Local rule-based routine engine.
Builds AM/PM skincare routines from SkinMetrics + profile.
Priority-first active ingredient selection, safety adjustments, ramp schedule.
"""
